...
<a href="{{ route('dokumen.lihat', basename($item->slip_ukt)) }}" target="_blank"
   style="display:inline-block; background-color:#e0f2fe; color:#0369a1;
          border:1px solid #bae6fd; padding:6px 12px; font-size:0.75rem;
          font-weight:600; border-radius:6px; text-decoration:none;">
    👁️ Lihat Slip UKT
                        </a>

                        {{-- Kolom 5: KRS Terbaru --}}
                        <a href="{{ route('dokumen.lihat', basename($item->krs_terbaru)) }}" target="_blank"
                        style="display:inline-block; background-color:#d1fae5; color:#047857;
                                border:1px solid #a7f3d0; padding:6px 12px; font-size:0.75rem;
                                font-weight:600; border-radius:6px; text-decoration:none;">
                            👁️ Lihat KRS Terbaru
                        </a>
